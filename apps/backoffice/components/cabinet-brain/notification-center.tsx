...
import { cabinetBrainDeepLink } from './vision-links';
...
export function NotificationCenter() {
  ...
  async function load() {
    const response = await fetch('/api/vision/notifications', { cache: 'no-store' });
